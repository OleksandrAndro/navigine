                ...
                navigationManager.addPositionListener(new PositionListener() {
                    ...
                    public void onPositionUpdated(Position position) {
                       ...
                       /* if(isShowToast) {
                            ...
                            distanceToast = Toast.makeText(getApplicationContext(), "distance = " + distance, Toast.LENGTH_SHORT);
                            distanceToast.show();
                        }*/
                        ...
                        LocationPoint mLocationPointGr1 = new LocationPoint(getProductPoint("Grocery1"), LOCATION_ID, SUBLOCATION_ID);
                        LocationPoint mLocationPointSweets = new LocationPoint(getProductPoint("Sweets"), LOCATION_ID, SUBLOCATION_ID);
                        LocationPoint mLocationPointDrinks = new LocationPoint(getProductPoint("Drinks"), LOCATION_ID, SUBLOCATION_ID);
                        LocationPoint mLocationPointTea = new LocationPoint(getProductPoint("Tea"), LOCATION_ID, SUBLOCATION_ID);
                        Point destPoint = mLocationPoint.getPoint();
                        ...
                        float lenghtPathGrocery2 = pathGrocery2.getLength();
                        lenght2.setText("Lenght Grocery2 = "+ lenghtPathGrocery2);
